...
class Dropout_Layer(base_model):
    def __init__(self, config):
        ...
        self.drop = nn.Dropout(config.drop_out).to(config.device)
        ...
        self.linear_transform.to(config.device)
        self.layer_normalization = nn.LayerNorm([config.output_size]).to(config.device)
